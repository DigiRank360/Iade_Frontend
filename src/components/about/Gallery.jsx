...
/* =========================================================
   ...
   Automatically loads ALL .jpeg images from:
   src/assets/images/
========================================================= */
...
const SORTED_LOCAL_IMAGES = Object.entries(LOCAL_IMAGES)
  .sort(([pathA], [pathB]) => {
    const numberA = parseInt(
      pathA.match(/(\d+)\.jpeg$/i)?.[1] || '0',
      10
    );

    const numberB = parseInt(
      pathB.match(/(\d+)\.jpeg$/i)?.[1] || '0',
      10
    );
...
/* =========================================================
   ...
   First 16 images keep the existing content.
========================================================= */
...
/* =========================================================
   GENERATE GALLERY ARRAY AUTOMATICALLY
   Every image inside src/assets/images/*.jpeg is included.
========================================================= */

const GALLERY_IMAGES = SORTED_LOCAL_IMAGES.map((src, index) => {
  const existingInfo = IMAGE_INFO[index];

  return {
    id: index + 1,
    src,

    category: existingInfo?.category || 'classroom',
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#050505] text-white">
      ...
      <style>{`
        ...
        .gallery-reveal {
          animation:
            revealUp .8s cubic-bezier(.2,.8,.2,1) both;
        }
        ...
        .lightbox-animation {
          animation:
            lightboxIn .4s cubic-bezier(.2,.8,.2,1);
        }
      ...
      <section className="relative isolate overflow-hidden px-5 pb-20 pt-28 sm:px-8 sm:pt-32 lg:px-12 lg:pb-28">
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          >
            Explore the learning, celebrations,
            achievements and unforgettable moments
            that make the IADE student community special.
          </p>
      ...
      <section className="relative overflow-hidden border-t border-white/[0.06] px-5 py-20 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-white/40">
            ...
            Join the IADE community, build real-world
            skills, create your portfolio and become part
            of our next success story.
